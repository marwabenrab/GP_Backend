...
if (isset($_POST['adress']) && 
    ...
    if (isset($_FILES['image_own']) && isset($_FILES['image_payment'])) {
        ...
        if (move_uploaded_file($imageOwn['tmp_name'], $imageOwnPath) && 
            ...
            $sql = "INSERT INTO `land` (`adress`, `phone`, `status`, `image_own`, `image_payment` ,`coord_X`, `coord_Y`) 
                    VALUES ('$adress', '$phone', '$status', '$imageOwnPath', '$imagePaymentPath' , '$coordx',  '$coordy')";
